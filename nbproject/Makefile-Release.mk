...
${OBJECTDIR}/LzmaDec.o: LzmaDec.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LzmaDec.o LzmaDec.c

${OBJECTDIR}/compr_lzma.o: compr_lzma.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/compr_lzma.o compr_lzma.c

${OBJECTDIR}/jffs2dump.o: jffs2dump.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jffs2dump.o jffs2dump.c

${OBJECTDIR}/jffs2extract.o: jffs2extract.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jffs2extract.o jffs2extract.c

${OBJECTDIR}/libcrc32.o: libcrc32.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libcrc32.o libcrc32.c

${OBJECTDIR}/minilzo.o: minilzo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/minilzo.o minilzo.c
